    ...
    try{
        ...
        if(req.session.vendors._id == uid){ 
            ...
            if(details === false){             
                ...
                let response = await axios.post('http://localhost:3000/admin/updateData/data', {
...
const fetchProducts = async (req, res) => {
    try{
        ...
        if (productids !== null) {
            ...
            let response = await axios.get('http://localhost:3000/admin/vendors/getvendorproducts', {
                products: productids
            })
